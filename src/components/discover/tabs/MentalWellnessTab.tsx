...
const MentalWellnessTab = ({ articles, books }: MentalWellnessTabProps) => {
  ...
  const philosopherImages = {
    ...
    'Marcus Aurelius': 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/Marcus_Aurelius_Metropolitan_Museum.png/800px-Marcus_Aurelius_Metropolitan_Museum.png',
